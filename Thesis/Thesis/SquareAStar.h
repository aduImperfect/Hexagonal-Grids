...
double SquareAStar(Position npStart, Position npGoal, bool autoCompute, Position topLeft, Position bottomRight, const int showMap)
{
  ...
  */
  ...
  while (!priorityFrontier.empty())
  {
    ...
    */
    ...
    cost_so_far[next] = new_cost
    */
    if ((mapVisited[currentNorth.p_x][currentNorth.p_y] != WALL) && !SquareIsOutside(currentNorth, topLeft, bottomRight))
    {
    ...
    if ((mapVisited[currentNorthEast.p_x][currentNorthEast.p_y] != WALL) && !SquareIsOutside(currentNorthEast, topLeft, bottomRight))
    {
    ...
    if ((mapVisited[currentEast.p_x][currentEast.p_y] != WALL) && !SquareIsOutside(currentEast, topLeft, bottomRight))
    {
    ...
    if ((mapVisited[currentSouthEast.p_x][currentSouthEast.p_y] != WALL) && !SquareIsOutside(currentSouthEast, topLeft, bottomRight))
    {
    ...
    if ((mapVisited[currentSouth.p_x][currentSouth.p_y] != WALL) && !SquareIsOutside(currentSouth, topLeft, bottomRight))
    {
    ...
    if ((mapVisited[currentSouthWest.p_x][currentSouthWest.p_y] != WALL) && !SquareIsOutside(currentSouthWest, topLeft, bottomRight))
    {
    ...
    if ((mapVisited[currentWest.p_x][currentWest.p_y] != WALL) && !SquareIsOutside(currentWest, topLeft, bottomRight))
    {
    ...
    if ((mapVisited[currentNorthWest.p_x][currentNorthWest.p_y] != WALL) && !SquareIsOutside(currentNorthWest, topLeft, bottomRight))
    {
